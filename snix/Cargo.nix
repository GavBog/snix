  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest-tracing" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            rename = "tracing-opentelemetry_0_31_pkg";
            optional = true;
          }
        ];
        devDependencies = [
      ...
      "snix-castore" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "virtio-bindings 0.2.6";
            optional = true;
          }
          {
            name = "virtio-queue";
      ...
      "tokio-listener" = rec {
        ...
        version = "0.5.2";
        edition = "2021";
        sha256 = "17f76804jmcf3hxnh17j0l35w3clpvj050133ilhbxyvjmr9r968";
        ...
        features = {
          ...
          "tonic010" = [
            "dep:tonic_010"
            "tokio-vsock?/tonic010"
          ];
          "tonic011" = [
            "dep:tonic_011"
            "tokio-vsock?/tonic011"
          ];
          "tonic012" = [
            "dep:tonic_012"
            "tokio-vsock?/tonic012"
          ];
          "tonic013" = [
            "dep:tonic_013"
            "tokio-vsock?/tonic013"
          ];
          "tonic014" = [
            "dep:tonic_014"
            "tokio-vsock?/tonic014"
          ];
          "unix_path_tools" = [ "nix" ];
          "user_facing_default" = [
            "inetd"
      ...
      "tokio-vsock" = rec {
        crateName = "tokio-vsock";
        version = "0.7.2";
        edition = "2018";
        sha256 = "1izis04x0my0mz8sklf9kp3x04ds8mdhiw5lw6rdm2a877wrwccb";
        libName = "tokio_vsock";
        authors = [
          "fsyncd"
          "rust-vsock"
        ...
        features = {
          "axum08" = [ "dep:axum08" ];
          "tonic010" = [ "dep:tonic010" ];
          "tonic011" = [ "dep:tonic011" ];
          "tonic012" = [ "dep:tonic012" ];
          "tonic013" = [ "dep:tonic013" ];
        ...
        resolvedDefaultFeatures = [ "tonic013" ];
      };
      "toml 0.6.0" = rec {
        crateName = "toml";
        version = "0.6.0";
      ...
      "tonic-health" = rec {
        ...
        version = "0.13.1";
        edition = "2021";
        sha256 = "0jya3573wclwr4lk4llv0dgnva249mwn0viva7xgw4q36i6k71yb";
      ...
      "tower-otel-http-metrics" = rec {
        ...
        version = "0.16.0";
        edition = "2021";
        sha256 = "13i47nrgy7qr6ivsgqfmr46c7p6ikpb15crk368k27nm2hidw7cc";
      ...
      "virtio-bindings 0.2.6" = rec {
        crateName = "virtio-bindings";
        version = "0.2.6";
        edition = "2021";
        sha256 = "1jzqrah4sibnaa80hwd1qk28dwn3d4wcvgdqpgkkp9nm4s54jkw0";
        libName = "virtio_bindings";
        authors = [
          "Sergio Lopez <slp@redhat.com>"
        ];
